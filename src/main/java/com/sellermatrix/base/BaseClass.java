...
import com.sellermatrix.listeners.ExtentListeners;
import com.sellermatrix.utilities.ExcelReader;
...
////			log.debug("IE initialized");
//
////}
//			/*
//			 * env = PropertiesReader.getPropertyValue("env"); System.out.println(env);
//			 * driver.get(PropertiesReader.getPropertyValue(env + "_AppURL"));
//			 * driver.manage().timeouts().implicitlyWait(
//			 * Integer.parseInt(PropertiesReader.getPropertyValue("implicit.wait")),TimeUnit
//			 * .SECONDS);
//			 * 
//			 * driver.manage().timeouts().pageLoadTimeout(
//			 * Integer.parseInt(PropertiesReader.getPropertyValue("pageLoad.wait")),TimeUnit
//			 * .SECONDS);
//			 */
...
//		log.debug("Environment value:" + env);
		...
		driver.manage().timeouts().implicitlyWait(Integer.parseInt(PropertiesReader.getPropertyValue("implicit.wait")),
				TimeUnit.SECONDS);
//		log.debug("Browser driver launched with URL:" + PropertiesReader.getPropertyValue(env + "_AppURL"));
		// ExtentListeners.testReport.get().log(Status.INFO,"Öpening browser...");
		// extentReport.log(Status.INFO,"Opening browser");

//		ErrorCollector.extentLogInfo("Opening browser with app url");
